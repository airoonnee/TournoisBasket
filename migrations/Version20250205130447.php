 ...
 */
final class Version20250205130447 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE matches (id INT AUTO_INCREMENT NOT NULL, round INT NOT NULL, team1_score INT NOT NULL, team2_score INT NOT NULL, match_date DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
