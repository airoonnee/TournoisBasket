 ...
 */
final class Version20250206110049 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE matches_tournaments ADD CONSTRAINT FK_CA209B2C4B30DD19 FOREIGN KEY (matches_id) REFERENCES matches (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE matches ADD CONSTRAINT FK_62615BABE120E4E FOREIGN KEY (tournament_id_id) REFERENCES tournaments (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
